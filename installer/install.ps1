...
Write-Host '===== YOMI 4.2.0.2 - YOUTUBE OBS MUSIC INTERFACE =====' -ForegroundColor Cyan
Write-Host ''
...
function Download-FileWithProgress {
    ...
    $request.UserAgent = 'YOMI-4.2.0.2-Installer'
