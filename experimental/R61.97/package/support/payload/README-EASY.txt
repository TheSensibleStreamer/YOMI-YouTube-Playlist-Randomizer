YOMI 4.2.0.8 R61.97 - EXPERIMENTAL BETA
========
...
R61.97 BETA CHANGES
-------------------
- More compact controller layout with less wasted space.
- Better live resizing and small-window behavior.
- Cleaner Queue controls and denser table layout.
- Larger, sharper visualizer presentation.
- Improved artwork edge and crop handling.
...
- 240p and 360p downloads now try genuinely separate compatibility routes. A
  ...
  for their real height before YOMI accepts them.
- Smart Crop can now remove exceptionally deep, confidently black borders.
  Wide title cards keep enough padding to preserve the complete wordmark.
